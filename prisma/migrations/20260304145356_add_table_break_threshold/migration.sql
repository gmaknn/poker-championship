...
INSERT INTO "new_Tournament" ("buyInAmount", "createdAt", "createdById", "currentLevel", "date", "finishedAt", "id", "lastRebalancedAtLevel", "levelDuration", "lightRebuyAmount", "lightRebuyEnabled", "lightRebuyMinBB", "maxRebuysPerPlayer", "name", "prizeDistribution", "prizePayoutCount", "prizePayoutPercents", "prizePayoutUpdatedAt", "prizePool", "prizePoolAdjustment", "prizePoolAdjustmentReason", "rebuyEndLevel", "seasonId", "seasonLeaderAtStartId", "seatsPerTable", "startingChips", "status", "tablesCount", "targetDuration", "timerElapsedSeconds", "timerPausedAt", "timerStartedAt", "totalPlayers", "type", "updatedAt") SELECT "buyInAmount", "createdAt", "createdById", "currentLevel", "date", "finishedAt", "id", "lastRebalancedAtLevel", "levelDuration", "lightRebuyAmount", "lightRebuyEnabled", "lightRebuyMinBB", "maxRebuysPerPlayer", "name", "prizeDistribution", "prizePayoutCount", "prizePayoutPercents", "prizePayoutUpdatedAt", "prizePool", "prizePoolAdjustment", "prizePoolAdjustmentReason", "rebuyEndLevel", "seasonId", "seasonLeaderAtStartId", "seatsPerTable", "startingChips", "status", "tablesCount", "targetDuration", "timerElapsedSeconds", "timerPausedAt", "timerStartedAt", "totalPlayers", "type", "updatedAt" FROM "Tournament";
