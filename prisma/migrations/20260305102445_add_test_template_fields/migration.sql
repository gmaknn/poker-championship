...
CREATE TABLE "new_Tournament" (
    ...
    "tableBreakThreshold" INTEGER NOT NULL DEFAULT 3,
    "currentLevel" INTEGER NOT NULL DEFAULT 1,
    "timerStartedAt" DATETIME,
    "timerPausedAt" DATETIME,
    "timerElapsedSeconds" INTEGER NOT NULL DEFAULT 0,
    "lastRebalancedAtLevel" INTEGER,
    "bustsAutoEliminatedAtLevel" INTEGER,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    "finishedAt" DATETIME,
    "isTestTemplate" BOOLEAN NOT NULL DEFAULT false,
    "isTestGenerated" BOOLEAN NOT NULL DEFAULT false,
    "seasonLeaderAtStartId" TEXT,
...
INSERT INTO "new_Tournament" ("bustsAutoEliminatedAtLevel", "buyInAmount", "createdAt", "createdById", "currentLevel", "date", "finishedAt", "id", "lastRebalancedAtLevel", "levelDuration", "lightRebuyAmount", "lightRebuyEnabled", "lightRebuyMinBB", "maxRebuysPerPlayer", "name", "prizeDistribution", "prizePayoutCount", "prizePayoutPercents", "prizePayoutUpdatedAt", "prizePool", "prizePoolAdjustment", "prizePoolAdjustmentReason", "rebuyEndLevel", "seasonId", "seasonLeaderAtStartId", "seatsPerTable", "startingChips", "status", "tableBreakThreshold", "tablesCount", "targetDuration", "timerElapsedSeconds", "timerPausedAt", "timerStartedAt", "totalPlayers", "type", "updatedAt") SELECT "bustsAutoEliminatedAtLevel", "buyInAmount", "createdAt", "createdById", "currentLevel", "date", "finishedAt", "id", "lastRebalancedAtLevel", "levelDuration", "lightRebuyAmount", "lightRebuyEnabled", "lightRebuyMinBB", "maxRebuysPerPlayer", "name", "prizeDistribution", "prizePayoutCount", "prizePayoutPercents", "prizePayoutUpdatedAt", "prizePool", "prizePoolAdjustment", "prizePoolAdjustmentReason", "rebuyEndLevel", "seasonId", "seasonLeaderAtStartId", "seatsPerTable", "startingChips", "status", "tableBreakThreshold", "tablesCount", "targetDuration", "timerElapsedSeconds", "timerPausedAt", "timerStartedAt", "totalPlayers", "type", "updatedAt" FROM "Tournament";
