...
CREATE TABLE "BlindLevel" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "BlindLevel_tournamentId_fkey" FOREIGN KEY ("tournamentId") REFERENCES "Tournament" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Elimination" (
    ...
    CONSTRAINT "Elimination_eliminatorId_fkey" FOREIGN KEY ("eliminatorId") REFERENCES "Player" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "ChipSetDenomination" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "ChipSetDenomination_chipSetId_fkey" FOREIGN KEY ("chipSetId") REFERENCES "ChipSet" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "TournamentChipConfig" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "TournamentChipConfig_tournamentId_fkey" FOREIGN KEY ("tournamentId") REFERENCES "Tournament" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "ChipDenomination" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "ChipDenomination_tournamentId_fkey" FOREIGN KEY ("tournamentId") REFERENCES "Tournament" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Settings" (
    ...
    "clubLogo" TEXT,
    "defaultBuyIn" REAL NOT NULL DEFAULT 10,
