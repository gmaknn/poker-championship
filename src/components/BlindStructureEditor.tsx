  ...
  return (
    <div className="space-y-6">
      ...
      {chipConfig && smallestChip && (
        <div className="bg-muted/50 px-4 py-3 rounded-lg border border-border flex items-start gap-3">
      ...
      {levels.length === 0 ? (
        ...
        <div className="space-y-4">
          ...
          <div className="max-h-[600px] overflow-y-auto rounded-lg border border-border">
            {/* Sticky header */}
            <div className="grid grid-cols-[40px_50px_0.9fr_0.9fr_0.9fr_0.9fr_100px_110px_70px] gap-3 px-4 py-3 font-medium text-sm bg-card text-foreground sticky top-0 z-10 border-b border-border">
              <div></div>
              <div>Niveau</div>
              <div>Small Blind</div>
              <div>Big Blind</div>
